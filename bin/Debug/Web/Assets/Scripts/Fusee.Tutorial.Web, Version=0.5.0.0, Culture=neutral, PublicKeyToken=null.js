...
'use strict';
var $asm0A = JSIL.DeclareAssembly("Fusee.FuFiCycles.Web, Version=0.5.0.0, Culture=neutral, PublicKeyToken=null");

JSIL.SetEntryPoint($asm0A, $asm0A.TypeRef("Fusee.FuFiCycles.Web.FuFiCycles"), "Main", JSIL.MethodSignature.Void);
...
(function FuFiCycles$Members () {
  ...
  var $T07 = function () {
    return ($T07 = JSIL.Memoize($asm0A.Fusee.FuFiCycles.Web.FuFiCycles_$l$gc)) ();
  };
  var $T08 = function () {
  ...
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm09.Fusee.FuFiCycles.Core.FuFiCycles)) ();
  };
  var $T0B = function () {
  ...
  function FuFiCycles_Main () {
    ...
    if ((arg_4D_1 = $T07().$l$g9__0_0) === null) {
      arg_4D_1 = $T07().$l$g9__0_0 = $T00().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm0A.Fusee.FuFiCycles.Web.FuFiCycles_$l$gc, "$lMain$gb__0_0", $S00(), false, false));
    }
    handler.Decoder = arg_4D_1;
    if ((arg_73_1 = $T07().$l$g9__0_1) === null) {
      arg_73_1 = $T07().$l$g9__0_1 = $T01().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm0A.Fusee.FuFiCycles.Web.FuFiCycles_$l$gc, "$lMain$gb__0_1", $S01(), false, false));
    }
    ...
    if ((arg_BA_1 = $T07().$l$g9__0_2) === null) {
      arg_BA_1 = $T07().$l$g9__0_2 = $T00().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm0A.Fusee.FuFiCycles.Web.FuFiCycles_$l$gc, "$lMain$gb__0_2", $S02(), false, false));
    }
    handler.Decoder = arg_BA_1;
    if ((arg_E0_1 = $T07().$l$g9__0_3) === null) {
      arg_E0_1 = $T07().$l$g9__0_3 = $T01().New($T07().$l$g9, null, new JSIL.MethodPointerInfo($asm0A.Fusee.FuFiCycles.Web.FuFiCycles_$l$gc, "$lMain$gb__0_3", $S03(), false, false));
    }
